"""
Advanced inventory feature data-access layer.
...
it is the responsibility of the controller to wrap these calls with
validation, business rules and audit logging.
...
a merge nightmare. Keeping advanced inventory isolated makes the change easy
to revert and to review.
"""
